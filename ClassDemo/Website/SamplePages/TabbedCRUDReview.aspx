    ...
    <uc1:MessageUserControl runat="server" ID="MessageUserControl" />
     <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-pane fade in active" id="listviewcrud">
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                            <asp:ListView ID="ListViewCRUD" runat="server" DataSourceID="ListViewCRUDODS" InsertItemPosition="LastItem" DataKeyNames="AlbumId">
                                <AlternatingItemTemplate>
                                    <tr style="background-color: #FFF8DC;">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ArtistIdDropDownList" runat="server" DataSourceID="ArtistListODS" DataTextField="Name" DataValueField="ArtistId" SelectedValue='<%#  Eval("ArtistId")%>' Enabled="false"></asp:DropDownList>
                                ...
                                <EditItemTemplate>
                                    <tr style="background-color: #008A8C; color: #FFFFFF;">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ArtistIdDropDownList" runat="server" DataSourceID="ArtistListODS" DataTextField="Name" DataValueField="ArtistId" SelectedValue='<%#  Bind("ArtistId")%>'></asp:DropDownList>
                                        <td align="center">
                            ...
                            <asp:ObjectDataSource ID="ListViewCRUDODS" runat="server" DataObjectTypeName="Chinook.Data.Entities.Album" DeleteMethod="Albums_Delete" InsertMethod="Albums_Add" OldValuesParameterFormatString="original_{0}" SelectMethod="Albums_List" TypeName="ChinookSystem.BLL.AlbumController" UpdateMethod="Albums_Update" OnDeleted="CheckForException" OnInserted="CheckForException" OnUpdated="CheckForException" OnSelected="CheckForException">
         ...
         <%-- Some people will collect all ODS controls and place them in a single location for easy access. The ODS controls are NOT associated with a specific tab but instead the entire page --%>
    </div>
</asp:Content>
