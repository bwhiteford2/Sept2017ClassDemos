...
public partial class SamplePages_TabbedCRUDReview : System.Web.UI.Page
{
    ...
    protected void SearchResults_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        GridViewRow agrow = SearchResults.Rows[SearchResults.SelectedIndex]; // A Gridview Row = agrow. This was done to prevent writing the code multiple times, seen below. 
